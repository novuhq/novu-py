...
### `models.HTTPRequestStepResponseDto`

```python
value: models.HTTPRequestStepResponseDto = /* values here */
```

### `models.ToolStepResponseDto`

```python
value: models.ToolStepResponseDto = /* values here */
```
