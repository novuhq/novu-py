...
class Subscribers(BaseSDK):
    ...
    def list(
        ...
        *,
    ...
    ) -> Optional[models.SubscribersControllerListSubscribersResponse]:
        r"""Get subscribers
        ...
        request = models.SubscribersControllerListSubscribersRequest(
            page=page,
            limit=limit,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_listSubscribers",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerListSubscribersResponse(
                result=utils.unmarshal_json(
                    http_res.text,
                    models.SubscribersControllerListSubscribersResponseBody,
                ),
                next=next_func,
    ...
    def create(
        ...
        *,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.CreateSubscriberRequestDto)
        request = cast(models.CreateSubscriberRequestDto, request)
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.CreateSubscriberRequestDto
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def retrieve(
        ...
        *,
        ...
        :param subscriber_id:
        :param include_topics: Includes the topics associated with the subscriber
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        """
    ...
    def update(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.SubscribersControllerUpdateSubscriberResponse:
        r"""Update subscriber
        ...
        request = models.SubscribersControllerUpdateSubscriberRequest(
            subscriber_id=subscriber_id,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_updateSubscriber",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerUpdateSubscriberResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.SubscriberResponseDto
                ),
                headers=utils.get_response_headers(http_res.headers),
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerRemoveSubscriberResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.DeleteSubscriberResponseDto
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(http_res, ["400", "404", "409"], "application/json"):
    ...
    def create_bulk(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.SubscribersControllerBulkCreateSubscribersResponse:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.BulkSubscriberCreateDto)
        request = cast(models.BulkSubscriberCreateDto, request)
        ...
        req = self.build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.BulkSubscriberCreateDto
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_bulkCreateSubscribers",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        data: Any = None
        if utils.match_response(http_res, "201", "application/json"):
            return models.SubscribersControllerBulkCreateSubscribersResponse(
                result=utils.unmarshal_json(
