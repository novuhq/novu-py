...
class Stats(BaseSDK):
    def retrieve(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.NotificationsControllerGetActivityStatsResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.ActivityStatsResponseDto
                ),
    ...
    def graph(
        ...
        *,
        ...
        r"""Get notification graph statistics
        ...
        req = self._build_request(
            method="GET",
            path="/v1/notifications/graph/stats",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.NotificationsControllerGetActivityGraphStatsResponse(
                result=utils.unmarshal_json(
                    http_res.text, List[models.ActivityGraphStatesResponse]
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(
