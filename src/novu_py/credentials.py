...
class Credentials(BaseSDK):
    def update(
        ...
        *,
    ...
    ) -> models.SubscribersControllerUpdateSubscriberChannelResponse:
        ...
        request = models.SubscribersControllerUpdateSubscriberChannelRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_updateSubscriberChannel",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerUpdateSubscriberChannelResponse(
    ...
    def append(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.SubscribersControllerModifySubscriberChannelResponse:
        ...
        request = models.SubscribersControllerModifySubscriberChannelRequest(
            subscriber_id=subscriber_id,
            update_subscriber_channel_request_dto=utils.get_pydantic_model(
                update_subscriber_channel_request_dto,
                models.UpdateSubscriberChannelRequestDto,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_modifySubscriberChannel",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerModifySubscriberChannelResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.SubscriberResponseDto
                ),
                headers=utils.get_response_headers(http_res.headers),
    ...
    def delete(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.SubscribersControllerDeleteSubscriberCredentialsResponse:
        ...
        request = models.SubscribersControllerDeleteSubscriberCredentialsRequest(
            subscriber_id=subscriber_id,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_deleteSubscriberCredentials",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "204", "*"):
            return models.SubscribersControllerDeleteSubscriberCredentialsResponse(
                headers=utils.get_response_headers(http_res.headers)
            )
        if utils.match_response(http_res, ["400", "404", "409"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ErrorDtoData)
