...
class Preferences(BaseSDK):
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_listSubscriberPreferences",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerListSubscriberPreferencesResponse(
                result=utils.unmarshal_json(
                    http_res.text, List[models.UpdateSubscriberPreferenceResponseDto]
                ),
    ...
    def update_global(
        ...
        *,
        subscriber_id: str,
        update_subscriber_global_preferences_request_dto: Union[
        ...
        r"""Update subscriber global preferences
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.update_subscriber_global_preferences_request_dto,
                False,
                False,
                "json",
                models.UpdateSubscriberGlobalPreferencesRequestDto,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_updateSubscriberGlobalPreferences",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return (
                models.SubscribersControllerUpdateSubscriberGlobalPreferencesResponse(
                    result=utils.unmarshal_json(
                        http_res.text,
                        models.UpdateSubscriberPreferenceGlobalResponseDto,
                    ),
                    headers=utils.get_response_headers(http_res.headers),
                )
            )
    ...
    def retrieve_by_level(
        ...
        *,
        ...
        r"""Get subscriber preferences by level
        ...
        request = models.SubscribersControllerGetSubscriberPreferenceByLevelRequest(
            include_inactive_channels=include_inactive_channels,
        ...
        req = self._build_request(
            method="GET",
            path="/v1/subscribers/{subscriberId}/preferences/{parameter}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_getSubscriberPreferenceByLevel",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerGetSubscriberPreferenceByLevelResponse(
                result=utils.unmarshal_json(
                    http_res.text, List[models.GetSubscriberPreferencesResponseDto]
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(
    ...
    async def retrieve_by_level_async(
        self,
        *,
        preference_level: models.Parameter,
        subscriber_id: str,
    ...
    def update(
        ...
        *,
        subscriber_id: str,
        workflow_id: str,
        update_subscriber_preference_request_dto: Union[
        ...
        r"""Update subscriber preference
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.update_subscriber_preference_request_dto,
                False,
                False,
                "json",
                models.UpdateSubscriberPreferenceRequestDto,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_updateSubscriberPreference",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerUpdateSubscriberPreferenceResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.UpdateSubscriberPreferenceResponseDto
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(
