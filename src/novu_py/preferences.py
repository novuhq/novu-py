...
class Preferences(BaseSDK):
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerGetSubscriberPreferencesResponse(
                result=unmarshal_json_response(
                    models.GetSubscriberPreferencesDto, http_res
                ),
    ...
    def bulk_update(
        ...
        *,
        subscriber_id: str,
        bulk_update_subscriber_preferences_dto: Union[
            models.BulkUpdateSubscriberPreferencesDto,
            models.BulkUpdateSubscriberPreferencesDtoTypedDict,
        ],
        idempotency_key: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.SubscribersControllerBulkUpdateSubscriberPreferencesResponse:
        r"""Bulk update subscriber preferences
        ...
        request = models.SubscribersControllerBulkUpdateSubscriberPreferencesRequest(
            subscriber_id=subscriber_id,
            idempotency_key=idempotency_key,
            bulk_update_subscriber_preferences_dto=utils.get_pydantic_model(
                bulk_update_subscriber_preferences_dto,
                models.BulkUpdateSubscriberPreferencesDto,
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.bulk_update_subscriber_preferences_dto,
                False,
                False,
                "json",
                models.BulkUpdateSubscriberPreferencesDto,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="SubscribersController_bulkUpdateSubscriberPreferences",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerBulkUpdateSubscriberPreferencesResponse(
                result=unmarshal_json_response(
                    List[models.GetPreferencesResponseDto], http_res
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(http_res, "414", "application/json"):
