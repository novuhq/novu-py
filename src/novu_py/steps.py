...
class Steps(BaseSDK):
    def generate_preview(
        ...
        *,
        workflow_id: str,
        step_id: str,
        generate_preview_request_dto: Union[
            models.GeneratePreviewRequestDto, models.GeneratePreviewRequestDtoTypedDict
        ],
        ...
        r"""Generate a step preview

        Generates a preview for a specific workflow step by its unique identifier **stepId**

        :param workflow_id:
        :param step_id:
        :param generate_preview_request_dto: Preview generation details
        ...
        request = models.WorkflowControllerGeneratePreviewRequest(
            workflow_id=workflow_id,
            step_id=step_id,
            idempotency_key=idempotency_key,
            generate_preview_request_dto=utils.get_pydantic_model(
                generate_preview_request_dto, models.GeneratePreviewRequestDto
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.generate_preview_request_dto,
                False,
                False,
                "json",
                models.GeneratePreviewRequestDto,
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="WorkflowController_generatePreview",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return models.WorkflowControllerGeneratePreviewResponse(
                result=unmarshal_json_response(
                    models.GeneratePreviewResponseDto, http_res
                ),
    ...
    def retrieve(
        ...
        *,
        ...
        request = models.WorkflowControllerGetWorkflowStepDataRequest(
            workflow_id=workflow_id,
            step_id=step_id,
            idempotency_key=idempotency_key,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="WorkflowController_getWorkflowStepData",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.WorkflowControllerGetWorkflowStepDataResponse(
                result=unmarshal_json_response(models.StepResponseDto, http_res),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(http_res, "414", "application/json"):
            response_data = unmarshal_json_response(models.ErrorDtoData, http_res)
