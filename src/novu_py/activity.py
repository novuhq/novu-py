...
class Activity(BaseSDK):
    def track(
        ...
        *,
        ...
        :param environment_id: The environment identifier
        :param integration_id: The integration identifier for the delivery provider
        :param request_body: Webhook event payload from the delivery provider
        ...
        request = models.InboundWebhooksControllerHandleWebhookRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="InboundWebhooksController_handleWebhook",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.WebhookResultDto], http_res)
