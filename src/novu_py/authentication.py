...
class Authentication(BaseSDK):
    def chat_access_oauth_call_back(
        ...
        *,
        request: Union[
            models.SubscribersControllerChatOauthCallbackRequest,
            models.SubscribersControllerChatOauthCallbackRequestTypedDict,
        ],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, models.SubscribersControllerChatOauthCallbackRequest
            )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_chatOauthCallback",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "text/html"):
            return models.SubscribersControllerChatOauthCallbackResponse(
    ...
    def chat_access_oauth(
        ...
        *,
        request: Union[
            models.SubscribersControllerChatAccessOauthRequest,
            models.SubscribersControllerChatAccessOauthRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, models.SubscribersControllerChatAccessOauthRequest
            )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_chatAccessOauth",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
