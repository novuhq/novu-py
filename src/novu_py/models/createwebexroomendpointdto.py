...
class CreateWebexRoomEndpointDtoContext2TypedDict(TypedDict):
...
class CreateWebexRoomEndpointDtoContext2(BaseModel):
    r"""Rich context object with id and optional data"""
...
CreateWebexRoomEndpointDtoContextTypedDict = TypeAliasType(
    "CreateWebexRoomEndpointDtoContextTypedDict",
    Union[CreateWebexRoomEndpointDtoContext2TypedDict, str],
)


CreateWebexRoomEndpointDtoContext = TypeAliasType(
    "CreateWebexRoomEndpointDtoContext", Union[CreateWebexRoomEndpointDtoContext2, str]
)


class CreateWebexRoomEndpointDtoType(str, Enum):
    r"""Type of channel endpoint"""

    WEBEX_ROOM = "webex_room"


class CreateWebexRoomEndpointDtoTypedDict(TypedDict):
    subscriber_id: str
    ...
    type: CreateWebexRoomEndpointDtoType
    r"""Type of channel endpoint"""
    endpoint: WebexRoomEndpointDtoTypedDict
    r"""Webex room endpoint data"""
    ...
    context: NotRequired[Dict[str, CreateWebexRoomEndpointDtoContextTypedDict]]
    connection_identifier: NotRequired[str]
    r"""The identifier of the channel connection to use for this Webex endpoint."""


class CreateWebexRoomEndpointDto(BaseModel):
    ...
    context: Optional[Dict[str, CreateWebexRoomEndpointDtoContext]] = None
...
try:
    CreateWebexRoomEndpointDto.model_rebuild()
except NameError:
    pass
