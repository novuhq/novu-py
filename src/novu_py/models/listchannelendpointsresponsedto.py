...
class ListChannelEndpointsResponseDtoTypedDict(TypedDict):
    data: List[GetChannelEndpointResponseDtoTypedDict]
    r"""List of returned Channel Endpoints"""
    next: Nullable[str]
...
class ListChannelEndpointsResponseDto(BaseModel):
    data: List[GetChannelEndpointResponseDto]
    r"""List of returned Channel Endpoints"""
...
try:
    ListChannelEndpointsResponseDto.model_rebuild()
except NameError:
    pass
