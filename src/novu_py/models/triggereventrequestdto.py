...
class TriggerEventRequestDtoTypedDict(TypedDict):
    ...
    r"""A URL to bridge for additional processing."""
    ...
    Existing tenants will be updated with the provided details.
    """
    controls: NotRequired[WorkflowToStepControlValuesDtoTypedDict]
    r"""Additional control configurations."""
...
class TriggerEventRequestDto(BaseModel):
    ...
    controls: Optional[WorkflowToStepControlValuesDto] = None
    r"""Additional control configurations."""
