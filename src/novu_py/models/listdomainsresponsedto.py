...
class ListDomainsResponseDtoTypedDict(TypedDict):
    data: List[DomainResponseDtoTypedDict]
    r"""List of returned domains"""
    next: Nullable[str]
...
class ListDomainsResponseDto(BaseModel):
    data: List[DomainResponseDto]
    r"""List of returned domains"""
...
try:
    ListDomainsResponseDto.model_rebuild()
except NameError:
    pass
