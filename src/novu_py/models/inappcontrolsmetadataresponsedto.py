...
class InAppControlsMetadataResponseDtoTypedDict(TypedDict):
    values: InAppControlDtoTypedDict
    r"""Control values specific to In-App"""
...
class InAppControlsMetadataResponseDto(BaseModel):
...
try:
    InAppControlsMetadataResponseDto.model_rebuild()
except NameError:
    pass
