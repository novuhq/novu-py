...
class ListContextsResponseDtoTypedDict(TypedDict):
    data: List[GetContextResponseDtoTypedDict]
    r"""List of returned Contexts"""
    next: Nullable[str]
...
class ListContextsResponseDto(BaseModel):
    data: List[GetContextResponseDto]
    r"""List of returned Contexts"""
...
try:
    ListContextsResponseDto.model_rebuild()
except NameError:
    pass
