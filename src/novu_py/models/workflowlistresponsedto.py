...
class WorkflowListResponseDtoLastNameTypedDict(TypedDict):
    r"""User last name"""


class WorkflowListResponseDtoLastName(BaseModel):
    r"""User last name"""
...
class WorkflowListResponseDtoUpdatedByTypedDict(TypedDict):
    ...
    r"""User first name"""
    last_name: NotRequired[Nullable[WorkflowListResponseDtoLastNameTypedDict]]
    r"""User last name"""
...
class WorkflowListResponseDtoUpdatedBy(BaseModel):
    ...
    last_name: Annotated[
        OptionalNullable[WorkflowListResponseDtoLastName],
        pydantic.Field(alias="lastName"),
    ] = UNSET
    r"""User last name"""
...
class WorkflowListResponseDtoLastPublishedByLastNameTypedDict(TypedDict):
    r"""User last name"""


class WorkflowListResponseDtoLastPublishedByLastName(BaseModel):
    r"""User last name"""
...
class WorkflowListResponseDtoLastPublishedByTypedDict(TypedDict):
    ...
    last_name: NotRequired[
        Nullable[WorkflowListResponseDtoLastPublishedByLastNameTypedDict]
    ]
    r"""User last name"""
    external_id: NotRequired[Nullable[str]]
    r"""User external ID"""
...
class WorkflowListResponseDtoLastPublishedBy(BaseModel):
    ...
    last_name: Annotated[
        OptionalNullable[WorkflowListResponseDtoLastPublishedByLastName],
        pydantic.Field(alias="lastName"),
    ] = UNSET
    r"""User last name"""
