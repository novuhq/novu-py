...
class SubscribersControllerGetSubscriberPreferenceByLevelRequestTypedDict(TypedDict):
...
class SubscribersControllerGetSubscriberPreferenceByLevelRequest(BaseModel):
...
class SubscribersControllerGetSubscriberPreferenceByLevelResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: List[GetSubscriberPreferencesResponseDtoTypedDict]


class SubscribersControllerGetSubscriberPreferenceByLevelResponse(BaseModel):
    headers: Dict[str, List[str]]
