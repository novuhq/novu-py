...
class CreateLineUserEndpointDtoContext2TypedDict(TypedDict):
...
class CreateLineUserEndpointDtoContext2(BaseModel):
    r"""Rich context object with id and optional data"""
...
CreateLineUserEndpointDtoContextTypedDict = TypeAliasType(
    "CreateLineUserEndpointDtoContextTypedDict",
    Union[CreateLineUserEndpointDtoContext2TypedDict, str],
)


CreateLineUserEndpointDtoContext = TypeAliasType(
    "CreateLineUserEndpointDtoContext", Union[CreateLineUserEndpointDtoContext2, str]
)


class CreateLineUserEndpointDtoType(str, Enum):
    r"""Type of channel endpoint"""

    LINE_USER = "line_user"


class CreateLineUserEndpointDtoTypedDict(TypedDict):
    subscriber_id: str
    ...
    type: CreateLineUserEndpointDtoType
    r"""Type of channel endpoint"""
    endpoint: LineUserEndpointDtoTypedDict
    r"""LINE user endpoint data"""
...
class CreateLineUserEndpointDto(BaseModel):
    ...
    context: Optional[Dict[str, CreateLineUserEndpointDtoContext]] = None
...
try:
    CreateLineUserEndpointDto.model_rebuild()
except NameError:
    pass
