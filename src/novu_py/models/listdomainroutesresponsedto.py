...
class ListDomainRoutesResponseDtoTypedDict(TypedDict):
    data: List[DomainRouteResponseDtoTypedDict]
...
class ListDomainRoutesResponseDto(BaseModel):
    data: List[DomainRouteResponseDto]
    r"""List of returned domain routes"""
...
try:
    ListDomainRoutesResponseDto.model_rebuild()
except NameError:
    pass
