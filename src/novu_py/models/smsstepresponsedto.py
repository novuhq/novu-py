...
class SmsStepResponseDtoControlValuesTypedDict(TypedDict):
    ...
    r"""Content of the SMS message."""


class SmsStepResponseDtoControlValues(BaseModel):
    r"""Control values for the SMS step"""
...
class SmsStepResponseDtoSlugTypedDict(TypedDict):
    r"""Slug of the step"""


class SmsStepResponseDtoSlug(BaseModel):
    r"""Slug of the step"""


class SmsStepResponseDtoTypedDict(TypedDict):
    controls: SmsControlsMetadataResponseDtoTypedDict
    r"""Controls metadata for the SMS step"""
    ...
    name: str
    r"""Name of the step"""
    slug: SmsStepResponseDtoSlugTypedDict
    r"""Slug of the step"""
    type: StepTypeEnum
    r"""Type of the step"""
    ...
    control_values: NotRequired[SmsStepResponseDtoControlValuesTypedDict]
    r"""Control values for the SMS step"""
    issues: NotRequired[StepIssuesDtoTypedDict]
    r"""Issues associated with the step"""


class SmsStepResponseDto(BaseModel):
    ...
    control_values: Annotated[
        Optional[SmsStepResponseDtoControlValues], pydantic.Field(alias="controlValues")
    ] = None
    r"""Control values for the SMS step"""
