...
class CreateTelegramChatEndpointDtoContext2TypedDict(TypedDict):
...
class CreateTelegramChatEndpointDtoContext2(BaseModel):
    r"""Rich context object with id and optional data"""
...
CreateTelegramChatEndpointDtoContextTypedDict = TypeAliasType(
    "CreateTelegramChatEndpointDtoContextTypedDict",
    Union[CreateTelegramChatEndpointDtoContext2TypedDict, str],
)


CreateTelegramChatEndpointDtoContext = TypeAliasType(
    "CreateTelegramChatEndpointDtoContext",
    Union[CreateTelegramChatEndpointDtoContext2, str],
)
...
class CreateTelegramChatEndpointDtoTypedDict(TypedDict):
    subscriber_id: str
    ...
    type: CreateTelegramChatEndpointDtoType
    r"""Type of channel endpoint"""
    endpoint: TelegramChatEndpointDtoTypedDict
    r"""Telegram chat endpoint data"""
    ...
    context: NotRequired[Dict[str, CreateTelegramChatEndpointDtoContextTypedDict]]
    connection_identifier: NotRequired[str]
    r"""The identifier of the channel connection to use for this channel endpoint."""


class CreateTelegramChatEndpointDto(BaseModel):
    ...
    context: Optional[Dict[str, CreateTelegramChatEndpointDtoContext]] = None
...
try:
    CreateTelegramChatEndpointDto.model_rebuild()
except NameError:
    pass
