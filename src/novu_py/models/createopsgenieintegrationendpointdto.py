...
class CreateOpsgenieIntegrationEndpointDtoContext2TypedDict(TypedDict):
...
class CreateOpsgenieIntegrationEndpointDtoContext2(BaseModel):
    r"""Rich context object with id and optional data"""
...
CreateOpsgenieIntegrationEndpointDtoContextTypedDict = TypeAliasType(
    "CreateOpsgenieIntegrationEndpointDtoContextTypedDict",
    Union[CreateOpsgenieIntegrationEndpointDtoContext2TypedDict, str],
)


CreateOpsgenieIntegrationEndpointDtoContext = TypeAliasType(
    "CreateOpsgenieIntegrationEndpointDtoContext",
    Union[CreateOpsgenieIntegrationEndpointDtoContext2, str],
)


class CreateOpsgenieIntegrationEndpointDtoType(str, Enum):
    r"""Type of channel endpoint"""

    OPSGENIE_INTEGRATION = "opsgenie_integration"


class CreateOpsgenieIntegrationEndpointDtoTypedDict(TypedDict):
    subscriber_id: str
    ...
    type: CreateOpsgenieIntegrationEndpointDtoType
    r"""Type of channel endpoint"""
    endpoint: OpsgenieIntegrationEndpointDtoTypedDict
    r"""Opsgenie integration endpoint data. `apiKey` is encrypted at rest on the channel endpoint (`endpoint` field); `region` remains plaintext. No linked channel connection."""
    ...
    context: NotRequired[
        Dict[str, CreateOpsgenieIntegrationEndpointDtoContextTypedDict]
    ]
    connection_identifier: NotRequired[str]
    r"""The identifier of the channel connection to use for this channel endpoint."""


class CreateOpsgenieIntegrationEndpointDto(BaseModel):
    ...
    context: Optional[Dict[str, CreateOpsgenieIntegrationEndpointDtoContext]] = None
...
try:
    CreateOpsgenieIntegrationEndpointDto.model_rebuild()
except NameError:
    pass
