...
from .notificationstepdata import NotificationStepData, NotificationStepDataTypedDict
...
class NotificationStepDtoTypedDict(TypedDict):
    id: NotRequired[str]
    ...
    variants: NotRequired[List[NotificationStepDataTypedDict]]


class NotificationStepDto(BaseModel):
    ...
    variants: Optional[List[NotificationStepData]] = None
