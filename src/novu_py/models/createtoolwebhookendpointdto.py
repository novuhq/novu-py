...
class CreateToolWebhookEndpointDtoContext2TypedDict(TypedDict):
...
class CreateToolWebhookEndpointDtoContext2(BaseModel):
    r"""Rich context object with id and optional data"""
...
CreateToolWebhookEndpointDtoContextTypedDict = TypeAliasType(
    "CreateToolWebhookEndpointDtoContextTypedDict",
    Union[CreateToolWebhookEndpointDtoContext2TypedDict, str],
)


CreateToolWebhookEndpointDtoContext = TypeAliasType(
    "CreateToolWebhookEndpointDtoContext",
    Union[CreateToolWebhookEndpointDtoContext2, str],
)


class CreateToolWebhookEndpointDtoType(str, Enum):
    r"""Type of channel endpoint"""

    TOOL_WEBHOOK = "tool_webhook"


class CreateToolWebhookEndpointDtoTypedDict(TypedDict):
    subscriber_id: str
    ...
    type: CreateToolWebhookEndpointDtoType
    r"""Type of channel endpoint"""
    endpoint: ToolWebhookEndpointDtoTypedDict
    r"""Tool webhook endpoint data. `url` and header values are encrypted at rest on the channel endpoint (`endpoint` field); `method` remains plaintext. No linked channel connection."""
    ...
    context: NotRequired[Dict[str, CreateToolWebhookEndpointDtoContextTypedDict]]
    connection_identifier: NotRequired[str]
    r"""The identifier of the channel connection to use for this channel endpoint."""


class CreateToolWebhookEndpointDto(BaseModel):
    ...
    context: Optional[Dict[str, CreateToolWebhookEndpointDtoContext]] = None
...
try:
    CreateToolWebhookEndpointDto.model_rebuild()
except NameError:
    pass
