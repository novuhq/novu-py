...
class Properties(BaseSDK):
    def update_online_flag(
        ...
        *,
    ...
    ) -> models.SubscribersControllerUpdateSubscriberOnlineFlagResponse:
        ...
        request = models.SubscribersControllerUpdateSubscriberOnlineFlagRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_updateSubscriberOnlineFlag",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerUpdateSubscriberOnlineFlagResponse(
