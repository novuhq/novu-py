...
class NovuNotifications(BaseSDK):
    def feed(
        ...
        *,
        request: Union[
            models.SubscribersControllerGetNotificationsFeedRequest,
            models.SubscribersControllerGetNotificationsFeedRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.SubscribersControllerGetNotificationsFeedResponse:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, models.SubscribersControllerGetNotificationsFeedRequest
            )
        request = cast(models.SubscribersControllerGetNotificationsFeedRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_getNotificationsFeed",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerGetNotificationsFeedResponse(
    ...
    def unseen_count(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.SubscribersControllerGetUnseenCountResponse:
        ...
        request = models.SubscribersControllerGetUnseenCountRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="SubscribersController_getUnseenCount",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerGetUnseenCountResponse(
